...
import com.example.edward.nyansapo.assess_process.word.WordAssessmentFragmentArgs
import com.example.edward.nyansapo.assess_process.word.WordAssessmentViewModel
...
@AndroidEntryPoint
class LetterAssessmentFragment : Fragment(R.layout.activity_letter_assessment) {
    private val TAG = "ParagraphAssessmentFrag"

    private lateinit var binding: ActivityWordAssessmentBinding
    private val navArgs: LetterAssessmentFragmentArgs by navArgs()
    private val viewModel: LetterAssessmentViewModel by viewModels()
    ...
    private fun subscribeToObservers() {
        viewLifecycleOwner.lifecycleScope.launchWhenResumed {
            launch {
                viewModel.letterAssessmentEvents.collect {
                    when (it) {
    ...
    private fun goToThankYou(assessment: Assessment) {
        findNavController().navigate(LetterAssessmentFragmentDirections.actionLetterAssessmentFragmentToThankYouFragment(assessment,navArgs.student))
    }
