package com.example.edward.nyansapo.numeracy.subtraction
...
@AndroidEntryPoint
class SubtractionFragment : Fragment(R.layout.fragment_addition) {

    private val TAG = "SubtractionFragment"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        initProgressBar()
        viewModel.setOperation(Operators.SUBTRACTION)
        setDefaults()
