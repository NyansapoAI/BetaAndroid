...
class MultiplicationLevelAssessmentResultFragment : Fragment(R.layout.fragment_multiplication_level_assessment_result) {


    private val TAG = "MultiplicationLevelAsse"
