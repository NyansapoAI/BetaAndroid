...
class ActivitiesAdapter2(val fragment: ActivitiesFragment2, val onSearchViewEmpty: () -> Unit, val onActivityClicked: (Activity) -> Unit) : ListAdapter<Activity, ActivitiesAdapter2.ViewHolder>(DIFF_UTIL) {
