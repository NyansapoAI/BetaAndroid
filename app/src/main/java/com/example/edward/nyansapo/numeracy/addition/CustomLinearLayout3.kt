...
class CustomLinearLayout3(context: Context?, attrs: AttributeSet?) : LinearLayout(context, attrs) {
...
/*
    override fun onDraw(canvas: Canvas) {
val bitmap=BitmapFactory.decodeResource(this.resources, R.drawable.arrow)
