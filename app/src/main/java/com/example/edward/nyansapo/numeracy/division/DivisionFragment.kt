package com.example.edward.nyansapo.numeracy.division
...
@AndroidEntryPoint
class DivisionFragment : Fragment(R.layout.fragment_addition) {


    private val TAG = "DivisionFragment"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        initProgressBar()
        viewModel.setOperation(Operators.DIVISION)
        setDefaults()
