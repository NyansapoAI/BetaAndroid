...
import com.example.edward.nyansapo.util.dateToString
...
@AndroidEntryPoint
class AttendanceFragment2 : Fragment(R.layout.activity_attendance) {
                ...
                viewModel.getCurrentDate.collect {
                    when (it.status) {
                        ...
                        Resource.Status.SUCCESS -> {
                            binding.dateBtn.text = it.data!!.dateToString
                            viewModel.setEvent(Event.InitDataFetching(it.data))
                        }
